...
if (!class_exists('CMB2_Tabs', false)) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            ...
            wp_register_script('cmb-tabs-js', CMB2_Utils::url('js/tabs.js'), array('jquery'), self::VERSION);
            wp_enqueue_script('cmb-tabs-js');

            wp_enqueue_style('cmb2-tabs-style', CMB2_Utils::url('css/tabs.css'), array(), self::VERSION);
